...
public class ImportController extends BaseController {
    ...
    @PostMapping("/towns")
    public ModelAndView importTownsConfirm(@RequestParam("towns") String towns) throws FileNotFoundException {
    ...
    public ModelAndView importDistrictsConfirm(@RequestParam("districts") String districts) throws FileNotFoundException {
    ...
    @PostMapping("/racers")
    public ModelAndView importRacersConfirm(@RequestParam("racers") String racers) throws FileNotFoundException {
    ...
    @PostMapping("/cars")
    public ModelAndView importCarsConfirm(@RequestParam("cars") String cars) throws FileNotFoundException {
